...
- **Evidence Gathering Under Uncertainty**: Threshold-based gating (0.20 < prob < 0.70). Clearly legitimate cases (prob <= 0.20) and confirmed customer disputes / confident fraud (prob >= 0.70) skip redundant verification. Only genuinely ambiguous model alerts request customer validation or step-up authentication (9/20 cases).
...
| Cases with evidence requests | 9 / 20 (strictly ambiguous model alerts) |
